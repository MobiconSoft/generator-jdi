...
Run `yo jdi`, optionally passing an app name:
```
yo jdi [app-name]
```
...
* App
    - [jdi](#app) (aka [jdi:app](#app))
* Server Side
    - [jdi:endpoint](#endpoint)
* Client Side
    - [jdi:route](#route)
    - [jdi:controller](#controller)
    - [jdi:filter](#filter)
    - [jdi:directive](#directive)
    - [jdi:service](#service)
    - [jdi:provider](#service)
    - [jdi:factory](#service)
    - [jdi:decorator](#decorator)
* Deployment
    - [jdi:openshift](#openshift)
    - [jdi:heroku](#heroku)
...
You can also do `yo jdi:factory` and `yo jdi:provider` for other types of services.
